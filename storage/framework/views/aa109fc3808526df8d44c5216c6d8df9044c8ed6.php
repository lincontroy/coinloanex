...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <!-- App js -->
        <script src="<?php echo e(asset('/backend/assets/js/scripts.js?v=1.2')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\cryptolending\resources\views/layouts/app.blade.php ENDPATH**/ ?>