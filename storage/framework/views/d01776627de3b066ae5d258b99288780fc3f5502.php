...
<body id="top">
    ...
    <!-- Main jQuery -->
    <script src="<?php echo e(asset('/theme/plugins/jquery/jquery-3.6.0.min.js')); ?>"></script>
    <!-- Bootstrap 4.3.2 -->
...
<?php /**PATH C:\xampp\htdocs\cryptolending\resources\views/theme/layout.blade.php ENDPATH**/ ?>